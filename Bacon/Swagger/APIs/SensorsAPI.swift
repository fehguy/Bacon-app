...
open class SensorsAPI: APIBase {
     ...
     */
    open class func getSensor(sensorId: String, completion: @escaping ((_ data: SensorStatus?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getSensors(zone: String? = nil, completion: @escaping ((_ data: [SensorStatus]?, _ error: ErrorResponse?) -> Void)) {
