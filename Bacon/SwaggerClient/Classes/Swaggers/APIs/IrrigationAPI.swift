...
open class IrrigationAPI {
     ...
     */
    public enum Format_sendIrrigationDailySummary: String { 
        case text = "text"
        case html = "html"
    }
    ...
    /**
     ...
     - parameter sendIfEmpty: (query) sends the summary even if there is no irrigation activity (optional, default to false)
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendIrrigationDailySummary(emailAddress: String? = nil, sendIfEmpty: Bool? = nil, resetOnSend: Bool? = nil, format: Format_sendIrrigationDailySummary? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        sendIrrigationDailySummaryWithRequestBuilder(emailAddress: emailAddress, sendIfEmpty: sendIfEmpty, resetOnSend: resetOnSend, format: format).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
     ...
     */
    open class func sendIrrigationDailySummaryWithRequestBuilder(emailAddress: String? = nil, sendIfEmpty: Bool? = nil, resetOnSend: Bool? = nil, format: Format_sendIrrigationDailySummary? = nil) -> RequestBuilder<String> {
        let path = "/irrigation/summary"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
